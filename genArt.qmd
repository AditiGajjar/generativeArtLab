...
## **Barbie Birkin - completely generative**
...
final_plot <- pic +
  ...
  scale_fill_gradient(low = "maroon4", high = "white", guide = "none")
final_plot
```
...
-   Outside of choosing colors, I combined two packages to create a sort of tiled texture design. I first used the ambient package to create that noise and diffused color look that I overlayed with tiles that I got from the voronoise package. I played around wiht the number of tiles, and the length of the noise until iIgot a pattern that was stark and interesting enough to capture my vision: 500 data points.
